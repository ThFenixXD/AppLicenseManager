                        ...
                        <ItemTemplate>
                            <div class="dropdown show">
                                ...
                                <ul class="dropdown-opGrid dropdown-menu">
                                    <li>
                                        <asp:LinkButton ID="lnkEditarUsuario" CssClass="lnkOp" runat="server" CommandName="opEditarUsuario">
                                            <span class="icon-op"><i class="fa-solid fa-user-pen"></i></span>
                                            <span class="text-op">Editar Usuário</span>
                                        </asp:LinkButton>

                                    </li>
                                    <li>
                                        <asp:LinkButton ID="lnkBloquearUsuario" CssClass="lnkOp" runat="server" CommandName="opAlteraStatus">
                                            <span class="icon-op"><i class="fa-solid fa-user-slash"></i></span>
